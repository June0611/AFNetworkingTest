...
static NSString *const XMLDictionaryAttributesKey   = @"attributes";
static NSString *const XMLDictionaryCommentsKey     = @"comments";
static NSString *const XMLDictionaryTextKey         = @"text";
static NSString *const XMLDictionaryNodeNameKey     = @"name";
